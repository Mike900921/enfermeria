    ...
    <div class="container user-select-none">
        ...
        <div class="row g-2 mb-2 buscador align-items-end">
            <div class="col-12 col-md-2">
                ...
                <input id="fecha_inicio" type="date" class="form-control" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="Desde" aria-label="Desde">
            </div>

            <div class="col-12 col-md-2">
                <label for="fecha_fin" class="form-label mb-1">Fecha hasta</label>
                <input id="fecha_fin" type="date" class="form-control" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="d-flex gap-2">
                    <input id="input-busqueda" type="search" class="form-control"
                        placeholder="Paciente, doc o enfermero" />
