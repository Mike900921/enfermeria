                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <!-- Botón para agregar -->
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalMotivo">
                                            +
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('motivos.store') }}" method="POST">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"data-bs-target="#modalCreateAtencion{{ $paciente->par_identificacion }}" data-bs-toggle="modal">
                                    Cancelar
                                </button>
                                <button type="submit" class="btn btn-primary">
                                    Agregar Motivo
