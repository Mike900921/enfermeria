                ...
                <table class="table  table-striped">
                    ...
                    <tbody>
                        @forelse ($topData as $query)
                            ...
                            @empty
                                <td colspan="3" class="text-center">No se encontraron datos para los filtros
                                    seleccionados.</td>
                            </tr>
                        @endforelse
                    </tbody>
                    ...
                    <form action="{{ route('estadisticas.index') }}" method="GET" class="card p-3 mb-4 shadow-sm">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold">Agrupar por:</label>
                                <select name="ver" class="form-control">
                                    <option value="ficha" {{ request('ver') == 'ficha' ? 'selected' : '' }}>Número de
                                        Ficha</option>
                                    <option value="programa" {{ request('ver') == 'programa' ? 'selected' : '' }}>Nombre
                                        del Programa</option>
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Buscar" name="buscador" class="form-control mt-4"
